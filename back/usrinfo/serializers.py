...
from .validators import unique_email_validator, unique_username_validator, username_validator, char_validator
...
#     class Meta:
#         model = AppUser
#         fields = ['username', 'firstName', 'lastName', 'email', 'password', 'password2', 'snapUsername','kikUsername','instaUsername', 'country', 'dateOfBirth']
