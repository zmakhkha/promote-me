...
function createThemeVars(flatTokens, options) {
  ...
  for (const [token, tokenValue] of Object.entries(flatTokens)) {
    ...
    cssVars = (0, import_lodash2.default)(
      cssVars,
...
var systemProps = (0, import_lodash4.default)(
  {},
  background,
  border,
  color,
...
var expandResponsive = (styles2) => (theme2) => {
  ...
  for (const key in styles2) {
    let value = runIfFn2(styles2[key], theme2);
    if (value == null)
      continue;
...
function getCss(options) {
  ...
  const css2 = (stylesOrFn, nested = false) => {
    ...
    for (let key in styles2) {
      ...
      const configProperty = runIfFn2(config2 == null ? void 0 : config2.property, theme2);
      if (!nested && (config2 == null ? void 0 : config2.static)) {
        const staticStyles = runIfFn2(config2.static, theme2);
...
function createResolver(theme2) {
  ...
  return function resolver(config2, prop, value, props) {
    ...
    for (let i = 0; i < len; i++) {
      ...
      const styles2 = runIfFn2((_a7 = config2[prop]) == null ? void 0 : _a7[normalized[i]], props);
      if (!styles2)
        continue;
      if (isMultipart) {
        (_b5 = config2.parts) == null ? void 0 : _b5.forEach((part) => {
          (0, import_lodash5.default)(result, {
      ...
      if (!isMultipart) {
        if (isSingle)
          (0, import_lodash5.default)(result, styles2);
        else
...
function resolveStyleConfig(config2) {
  return (props) => {
    ...
    return (0, import_lodash5.default)(
      {},
      runIfFn2((_a7 = config2.baseStyle) != null ? _a7 : {}, props),
...
var baseStyleField2 = defineStyle(
  (props) => {
    var _a7, _b5;
    return (_b5 = (_a7 = runIfFn3(inputTheme.baseStyle, props)) == null ? void 0 : _a7.field) != null ? _b5 : {};
  }
);
...
var baseStyle24 = definePartsStyle16((props) => {
  ...
  return {
    root: baseStyleRoot2,
    field: (_a7 = runIfFn3(baseStyleField2, props)) != null ? _a7 : {},
...
//# sourceMappingURL=chunk-VTJ2FL77.js.map
