...
import {
  ...
  withDefaultSize,
  withDefaultVariant
} from "./chunk-VTJ2FL77.js";
import {
  Global,
  _extends,
  keyframes,
  require_react_is
} from "./chunk-6XZVF2CG.js";
import {
  cancelSync,
  es_default,
  getFrameData
} from "./chunk-MP2KJS7I.js";
import {
  require_jsx_runtime
...
var ContainerPortal = (props) => {
  ...
  const [, forceUpdate] = (0, import_react3.useState)({});
  useSafeLayoutEffect2(() => forceUpdate({}), []);
  useSafeLayoutEffect2(() => {
    if (!portal || !host)
      return;
...
var useSafeLayoutEffect3 = typeof window !== "undefined" ? import_react58.useLayoutEffect : import_react58.useEffect;
...
function useAccordion(props) {
  ...
  const [index, setIndex] = useControllableState2({
    value: indexProp,
    defaultValue() {
      if (allowMultiple)
...
function useCheckbox(props = {}) {
  ...
  const onChangeProp = useCallbackRef2(onChange);
  const onBlurProp = useCallbackRef2(onBlur3);
  const onFocusProp = useCallbackRef2(onFocus3);
...
function useEventListener2(target, event, handler, options) {
...
function useFocusOnPointerDown2(props) {
  ...
  useEventListener2(doc, "pointerdown", (event) => {
    if (!isSafari() || !enabled)
      return;
...
function useEditable(props = {}) {
  ...
  const onEditProp = useCallbackRef2(onEditCallback);
...
function getOwnerWindow(node2) {
  var _a2, _b;
  return (_b = (_a2 = getOwnerDocument(node2)) == null ? void 0 : _a2.defaultView) != null ? _b : window;
}
...
var InputGroup = forwardRef(
  function InputGroup2(props, ref) {
    ...
    const clones = validChildren.map((child) => {
      ...
      return child.type.id !== "Input" ? (0, import_react100.cloneElement)(child, theming) : (0, import_react100.cloneElement)(child, Object.assign(theming, groupStyles, child.props));
    });
...
var Wrap = forwardRef(function Wrap2(props, ref) {
  ...
  const _children = (0, import_react101.useMemo)(
    () => shouldWrapChildren ? import_react101.Children.map(children, (child, index) => (0, import_jsx_runtime82.jsx)(WrapItem, { children: child }, index)) : children,
...
var Stack = forwardRef((props, ref) => {
  ...
  const dividerStyle = (0, import_react102.useMemo)(
    () => getDividerStyles({ spacing, direction }),
    [spacing, direction]
  );
  const hasDivider = !!divider;
  const shouldUseChildren = !shouldWrapChildren && !hasDivider;
  const clones = (0, import_react102.useMemo)(() => {
    const validChildren = getValidChildren(children);
    return shouldUseChildren ? validChildren : validChildren.map((child, index) => {
      ...
      if (!hasDivider)
        return _child;
      const clonedDivider = (0, import_react102.cloneElement)(
        divider,
        {
          __css: dividerStyle
        }
      ...
      return (0, import_jsx_runtime85.jsxs)(import_react102.Fragment, { children: [
        _child,
        _divider
      ] }, key);
    });
...
function useHighlight(props) {
  ...
  return (0, import_react103.useMemo)(() => highlightWords({ text, query }), [text, query]);
}
...
function Highlight(props) {
  ...
  return (0, import_jsx_runtime91.jsx)(import_jsx_runtime91.Fragment, { children: chunks.map((chunk, index) => {
    return chunk.match ? (0, import_jsx_runtime91.jsx)(Mark, { sx: styles, children: chunk.text }, index) : (0, import_jsx_runtime91.jsx)(import_react103.Fragment, { children: chunk.text }, index);
  }) });
}
...
var Indicator = forwardRef(function Indicator2(props, ref) {
  ...
  const styles = (0, import_react104.useMemo)(
    () => ({
      display: "inline-flex",
      justifyContent: "center",
      alignItems: "center",
...
var AspectRatio = forwardRef(function(props, ref) {
  ...
  const child = import_react105.Children.only(children);
...
function useFocusOnShow2(target, options = defaultOptions2) {
  ...
  useEventListener2(element, "transitionend", onFocus3);
}
...
function useDisclosure2(props = {}) {
  ...
  const handleOpen = useCallbackRef2(onOpenProp);
  const handleClose = useCallbackRef2(onCloseProp);
...
function useMenuItem(props = {}, externalRef = null) {
  ...
  const id3 = `${menuId}-menuitem-${(0, import_react115.useId)()}`;
...
function useModalManager(ref, isOpen) {
  const [index, setIndex] = (0, import_react120.useState)(0);
...
function useNumberInput(props = {}) {
  ...
  const onFocus3 = useCallbackRef2(onFocusProp);
  const onBlur3 = useCallbackRef2(onBlurProp);
  const onInvalid = useCallbackRef2(onInvalidProp);
  const isValidCharacter = useCallbackRef2(
  ...
  const parse3 = (0, import_react128.useCallback)(
    (value) => {
      var _a2;
  ...
  const format = (0, import_react128.useCallback)(
    (value) => {
      var _a2;
...
function usePinInput(props = {}) {
  ...
  const [moveFocus2, setMoveFocus] = (0, import_react130.useState)(true);
...
function useRadioGroup(props = {}) {
  ...
  const [valueState, setValue] = (0, import_react135.useState)(defaultValue || "");
  const isControlled = typeof valueProp !== "undefined";
  const value = isControlled ? valueProp : valueState;
  const ref = (0, import_react135.useRef)(null);
  const focus = (0, import_react135.useCallback)(() => {
  ...
  const getRootProps = (0, import_react135.useCallback)(
    (props2 = {}, forwardedRef = null) => ({
      ...props2,
  ...
  const getRadioProps = (0, import_react135.useCallback)(
    (props2 = {}, ref2 = null) => {
      const checkedKey = isNative ? "checked" : "isChecked";
      return {
        ...props2,
...
var RadioGroup = forwardRef((props, ref) => {
  ...
  const group = (0, import_react136.useMemo)(
    () => ({
      name,
      size,
      onChange,
...
function useRadio(props = {}) {
  ...
  const onKeyUp = (0, import_react137.useCallback)(
    (event) => {
      if (event.key === " ") {
        setActive(false);
      }
  ...
  const getRadioProps = (0, import_react137.useCallback)(
    (props2 = {}, ref = null) => ({
      ...props2,
      ref,
      "data-active": dataAttr(isActive),
...
var SelectIcon = (props) => {
  ...
  const clone = (0, import_react138.cloneElement)(children, {
    role: "presentation",
  ...
  return (0, import_jsx_runtime146.jsx)(IconWrapper, { ...rest, className: "chakra-select__icon-wrapper", children: (0, import_react138.isValidElement)(children) ? clone : null });
};
...
function useIsFirstRender() {
  const isFirstRender = (0, import_react139.useRef)(true);
...
function usePanEvent(ref, options) {
  ...
  const panSession = (0, import_react142.useRef)(null);
...
var useSafeLayoutEffect4 = Boolean(globalThis == null ? void 0 : globalThis.document) ? import_react143.useLayoutEffect : import_react143.useEffect;
...
function useSizes({
  ...
  const [sizes, setSizes] = (0, import_react143.useState)([]);
...
function useRangeSlider(props) {
  ...
  const [isDragging, setDragging] = (0, import_react144.useState)(false);
  const [isFocused, setFocused] = (0, import_react144.useState)(false);
  const [activeIndex, setActiveIndex] = (0, import_react144.useState)(-1);
  const isInteractive = !(isDisabled2 || isReadOnly);
  const initialValue = (0, import_react144.useRef)(valueState);
  ...
  const isVertical = orientation === "vertical";
  const trackRef = (0, import_react144.useRef)(null);
  const rootRef = (0, import_react144.useRef)(null);
  ...
  const getValueFromPointer = (0, import_react144.useCallback)(
    (event) => {
      var _a2, _b;
      if (!trackRef.current)
        return;
  ...
  const { getThumbStyle, rootStyle, trackStyle, innerTrackStyle } = (0, import_react144.useMemo)(
    () => getStyles3({
      isReversed,
      orientation,
      thumbRects,
  ...
  const focusThumb = (0, import_react144.useCallback)(
    (index) => {
      var _a2;
  ...
  const getRootProps = (0, import_react144.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ...htmlProps,
  ...
  const getTrackProps = (0, import_react144.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
  ...
  const getInnerTrackProps = (0, import_react144.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
  ...
  const getThumbProps = (0, import_react144.useCallback)(
    (props2, ref = null) => {
      var _a2;
      const { index, ...rest } = props2;
      ...
      return {
        ...
        onFocus: callAllHandlers2(props2.onFocus, () => {
          setFocused(true);
          setActiveIndex(index);
        }),
        onBlur: callAllHandlers2(props2.onBlur, () => {
          setFocused(false);
          setActiveIndex(-1);
        })
      };
  ...
  const getOutputProps = (0, import_react144.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
  ...
  const getMarkerProps = (0, import_react144.useCallback)(
    (props2, ref = null) => {
...
var RangeSlider = forwardRef(
  function RangeSlider2(props, ref) {
    ...
    const ctx = (0, import_react145.useMemo)(
...
function useSlider(props) {
  ...
  const [isDragging, setDragging] = (0, import_react146.useState)(false);
  const [isFocused, setFocused] = (0, import_react146.useState)(false);
  const isInteractive = !(isDisabled2 || isReadOnly);
  const tenSteps = (max2 - min2) / 10;
  const oneStep = step || (max2 - min2) / 100;
  ...
  const trackRef = (0, import_react146.useRef)(null);
  const thumbRef = (0, import_react146.useRef)(null);
  ...
  const getValueFromPointer = (0, import_react146.useCallback)(
    (event) => {
      var _a22, _b;
      if (!trackRef.current)
        return;
  ...
  const constrain = (0, import_react146.useCallback)(
    (value2) => {
      const state2 = stateRef.current;
  ...
  const { getThumbStyle, rootStyle, trackStyle, innerTrackStyle } = (0, import_react146.useMemo)(() => {
    const state2 = stateRef.current;
  ...
  const focusThumb = (0, import_react146.useCallback)(() => {
    const state2 = stateRef.current;
  ...
  const getTrackProps = (0, import_react146.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref: mergeRefs(ref, trackRef),
  ...
  const getInnerTrackProps = (0, import_react146.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ref,
  ...
  const getThumbProps = (0, import_react146.useCallback)(
    (props2 = {}, ref = null) => {
      return {
        ...props2,
        ...
        onKeyDown: callAllHandlers2(props2.onKeyDown, onKeyDown),
        onFocus: callAllHandlers2(props2.onFocus, () => setFocused(true)),
        onBlur: callAllHandlers2(props2.onBlur, () => setFocused(false))
      };
    },
    [
      isInteractive,
  ...
  const getMarkerProps = (0, import_react146.useCallback)(
    (props2, ref = null) => {
...
var Stepper = forwardRef(function Stepper2(props, ref) {
  ...
  const stepElements = import_react147.Children.toArray(children);
...
function useSteps(props = {}) {
  ...
  const [activeStep, setActiveStep] = (0, import_react148.useState)(index);
...
var Switch = forwardRef(function Switch2(props, ref) {
  ...
  const containerStyles = (0, import_react149.useMemo)(
    () => ({
      display: "inline-block",
      position: "relative",
      verticalAlign: "middle",
  ...
  const trackStyles = (0, import_react149.useMemo)(
    () => ({
      display: "inline-flex",
      flexShrink: 0,
  ...
  const labelStyles = (0, import_react149.useMemo)(
    () => ({
      userSelect: "none",
      marginStart: spacing,
      ...styles.label
...
function useTabs(props) {
  ...
  const [focusedIndex, setFocusedIndex] = (0, import_react150.useState)(defaultIndex != null ? defaultIndex : 0);
  const [selectedIndex, setSelectedIndex] = useControllableState2({
...
function useTabPanels(props) {
  ...
  const children = validChildren.map(
    (child, index) => (0, import_react150.createElement)(
      TabPanelProvider,
      {
        key: index,
        value: {
...
function useTabPanel(props) {
  ...
  const hasBeenSelected = (0, import_react150.useRef)(false);
  if (isSelected) {
...
function useTabIndicator() {
  ...
  const isHorizontal = orientation === "horizontal";
  const isVertical = orientation === "vertical";
  const [rect, setRect] = (0, import_react150.useState)(() => {
    if (isHorizontal)
  ...
  const [hasMeasured, setHasMeasured] = (0, import_react150.useState)(false);
  useSafeLayoutEffect2(() => {
...
var Tabs = forwardRef(function Tabs2(props, ref) {
  ...
  const context = (0, import_react151.useMemo)(() => ctx, [ctx]);
...
function useTooltip(props = {}) {
  ...
  useEventListener2(() => ref.current, "pointerleave", closeWithDelay);
  ...
  const getTooltipPositionerProps = (0, import_react152.useCallback)(
    (props2 = {}, forwardedRef = null) => getPopperProps(
      {
        ...props2,
        style: {
  ...
  const getTooltipProps = (0, import_react152.useCallback)(
    (props2 = {}, ref2 = null) => {
      const styles = {
        ...props2.style,
        position: "relative",
...
var Tooltip = forwardRef((props, ref) => {
  ...
  if (shouldWrap) {
    ...
    trigger2 = (0, import_react153.cloneElement)(
      child,
